    ...
    return (
        <div className="space-y-6">
            ...
            <Card>
              ...
              <span
                  className="text-2xl sm:text-3xl md:text-4xl font-mono font-bold tracking-widest text-indigo-600 dark:text-indigo-400">
                {room.roomCode}
              </span>
                            <button
                            ...
                            >
                                {copied ? (
                                    <svg className="w-5 h-5 sm:w-6 sm:h-6 text-green-500" fill="none"
