    ...
    <div className="space-y-4 sm:space-y-6">
      ...
      {!hasVoted ? (
        <Card>
          ...
          <div className="space-y-1.5 sm:space-y-2 mb-3 sm:mb-4">
            {votablePlayers.map((player) => (
              <button
                ...
                `}
              >
                <Avatar name={player.name} color={player.avatarColor} size="md" />
          ...
          <Button onClick={handleVote} disabled={!selectedId} variant="danger" className="w-full">
            ...
            .map((player) => (
              ...
              >
                ...
                {player.hasVoted ? (
                  ...
                  <svg
                    className="w-3 h-3 sm:w-4 sm:h-4 flex-shrink-0 animate-pulse"
                    fill="currentColor"
                    viewBox="0 0 20 20"
                  >
                    <path
