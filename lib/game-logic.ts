...
import {generatePlayerId, generateRoomCode, getRandomAvatarColor, pickRandom, shuffle, tallyVotes} from './utils';
...
export function processWordChangeVotes(room: GameRoom, locale: Locale = 'en'): {
    room: GameRoom;
    passed: boolean;
